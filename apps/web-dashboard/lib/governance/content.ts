...
const GOVERNANCE_DOC: GovernanceDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Unauthenticated GET / redirects to OIDC (no login landing HTML). Keycloak at /realms on the same host. Protected routes under /home, /tools, etc. Tokens in httpOnly cookies dd_access_token and dd_refresh_token.',
