...
export function timingProfileLabel(id: string): string {
  const labels: Record<string, string> = {
    ...
    happyguy_aasld_congress_print_pickup: 'HappyGuy — AASLD congress activation',
    happyguy_mps_website_update: 'HappyGuy — MPS website update (PRC/OPDP/deploy)',
    happyguy_branded_crm_email: 'HappyGuy — Branded CRM email (PRC/OPDP/Martech)',
