...
apps/ingestion-worker/ingestion/timeline_phase_catalog.py PHASE_ROWS and
apps/web-dashboard/lib/scenarioPlanner/phaseCatalog.ts.
"""
...
class PhaseCatalogRow(TypedDict):
    phase_id: str
    label: str
    order: int


PHASE_CATALOG: list[PhaseCatalogRow] = [
...
PRB_PHASE_IDS: frozenset[str] = frozenset(
    {'submit_prb1', 'prb1_review', 'submit_prb2', 'prb2_review', 'submit_prb3', 'prb3_review'},
)


def is_prb_phase_id(phase_id: str) -> bool:
    return phase_id in PRB_PHASE_IDS
